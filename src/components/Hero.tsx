      ...
      <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row items-center">
        <div className="flex-1 text-center lg:text-left mb-10 lg:mb-0">
          ...
          >
            ...
            specializing in full-stack development with Vue.js,
            React.js(Next.js), Laravel, and Spring Boot. I love building clean,
            responsive, and user-friendly web apps that turn ideas into real,
